...
export const LogoImage = tw.div`relative 2xl:w-[3.5rem] 2xl:h-[3.5rem] w-[3rem] h-[3rem] -left-[3px] 2xl:mt-3`;

export const Logo = tw.span`font-bold tracking-normal justify-center align-middle text-white self-center ml-1 text-3xl hidden xl:block 2xl:text-5xl`;
