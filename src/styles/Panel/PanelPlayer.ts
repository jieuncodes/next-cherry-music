...
export const PanelPlayerContainer = tw.div`rounded-xl w-full h-auto flex flex-col align-middle p-6 mb-1 overflow-scroll`;
...
export const Controllers = tw.div`w-full h-10 flex items-center justify-between gap-1 -ml-1 shrink-0`;
