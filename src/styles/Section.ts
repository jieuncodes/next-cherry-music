...
export const SectionContainer = tw.div`relative w-full mt-12 pr-6 mb-12 `;
...
export const SectionNav = tw.div`absolute right-10 w-[70px] flex justify-between -top-12`;
